...
export const createWishlistButton = 'button[class^="wishlistDialog-createListButton-"]';

export const wishlistNameField = 'input[id^="createWishlistForm-listname-"]';

export const createWishlistConfirmButton = 'button[class^="button-root_highPriority-"]';