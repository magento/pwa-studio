...
export const shippingMethodSectionButton =
    '[data-cy="CartPage-root"] [data-cy="PriceAdjustments-shippingMethodSection"] [data-cy="Section-titleContainer"]';

export const shippingMethodRadios =
    '[data-cy="CartPage-root"] [data-cy="PriceAdjustments-root"] [data-cy="ShippingMethods-root"] input[type="radio"]';

export const shippingMethodEstimateButton =
    '[data-cy="CartPage-root"] [data-cy="PriceAdjustments-root"] [data-cy="ShippingMethods-estimateButton"]';

export const shippingMethodCountrySelect =
    '[data-cy="CartPage-root"] [data-cy="PriceAdjustments-root"] [data-cy="ShippingMethods-ShippingForm-country"]';
...
export const couponCodeCouponCodeTextField =
    '[data-cy="CartPage-root"] [data-cy="PriceAdjustments-root"] [data-cy="CouponCode-couponCode"]';
