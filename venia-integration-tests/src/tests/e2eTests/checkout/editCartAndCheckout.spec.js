...
describe('PWA-1414: Verify cart editing and checkout', { tags: ['@commerce', '@open-source', '@ci'] },() => {
    it('should be able to edit a configurable product and place an order', () => {
        ...
        cy.wait(['@gqlUpdateConfigurableOptionsMutation'], { timeout: 60000 });
        ...
        assertPaymentInformationInCheckoutPage({ ...checkoutBillingData[1] });
        ...
        assertSelectedShippingMethodInCheckoutPage(fixedShippingMethod, true);
        assertProductInCheckoutPage(
            {
                name: productValeriaTwoLayeredTank.name,
                color: productValeriaTwoLayeredTank.color1,
