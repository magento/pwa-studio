...
describe('verify Google ReCaptcha in checkout', () => {
    it('user can fill and submit payment form and place order with inline badge position', () => {
        ...
        cy.intercept('POST', hitGraphqlPath, req => {
            ...
            if (req.body.operationName.includes('setSelectedPaymentMethod')) {
                req.reply({
         ...
         * Recaptcha
         */
        cy.wait(['@gqlGetReCaptchaV3ConfigInlineQuery']).its('response.body');
    ...
    it('user can fill and submit payment form and place order with default badge position', () => {
         ...
         * Recaptcha
         */
        cy.wait(['@gqlGetReCaptchaV3ConfigDefaultQuery']).its('response.body');
