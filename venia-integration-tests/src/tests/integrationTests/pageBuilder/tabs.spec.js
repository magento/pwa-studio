...
describe('PWA-1155: verify pagebuilder tabs content is rendered correctly', { tags: ['@commerce', '@open-source', '@ci'] },() => {
...
describe('PWA-1471: Verify pagebuilder tabs media query', { tags: ['@commerce', '@open-source', '@ci'] },() => {
