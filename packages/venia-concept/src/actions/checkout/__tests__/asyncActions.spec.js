...
describe('submitAddress', () => {
    ...
    test('submitAddress thunk dispatches actions on success', async () => {
        ...
        expect(dispatch).toHaveBeenNthCalledWith(1, actions.address.submit(payload));
        expect(dispatch).toHaveBeenNthCalledWith(2, expect.any(Function));
        expect(dispatch).toHaveBeenNthCalledWith(3, expect.any(Function));
        expect(dispatch).toHaveBeenNthCalledWith(4, expect.any(Function));
        expect(dispatch).toHaveBeenNthCalledWith(5, actions.address.accept(response));
    ...
    test('submitAddress thunk dispatches actions on failure', async () => {
        ...
        expect(dispatch).toHaveBeenNthCalledWith(1, actions.address.submit(payload));
        expect(dispatch).toHaveBeenNthCalledWith(2, expect.any(Function));
        expect(dispatch).toHaveBeenNthCalledWith(3, actions.address.reject(error));
...
describe('submitPaymentMethod', () => {
    ...
    test('submitPaymentMethod thunk returns undefined', async () => {
        const payload = { type: 'paymentMethod', formValues: { paymentMethod } };
    ...
    test('submitPaymentMethod thunk dispatches actions on success', async () => {
        ...
        expect(dispatch).toHaveBeenNthCalledWith(1, actions.paymentMethod.submit(payload));
        expect(dispatch).toHaveBeenNthCalledWith(2, actions.paymentMethod.accept(response));
        expect(dispatch).toHaveBeenCalledTimes(2);
    });
    ...
    test('submitPaymentMethod thunk dispatches actions on failure', async () => {
        ...
        expect(dispatch).toHaveBeenNthCalledWith(1, actions.paymentMethod.submit(payload));
        expect(dispatch).toHaveBeenNthCalledWith(2, actions.paymentMethod.reject(error));
        expect(dispatch).toHaveBeenCalledTimes(2);
    });
    ...
    test('submitPaymentMethod thunk throws if there is no guest cart', async () => {
        ...
        await expect(submitPaymentMethod(payload)(...thunkArgs)).rejects.toThrow(
            'guestCartId'
        );
    });
});
...
describe('submitShippingMethod', () => {
    ...
    test('submitShippingMethod thunk returns undefined', async () => {
        const payload = { type: 'shippingMethod', formValues: { shippingMethod } };
    ...
    test('submitShippingMethod thunk dispatches actions on success', async () => {
        ...
        expect(dispatch).toHaveBeenNthCalledWith(1, actions.shippingMethod.submit(payload));
        expect(dispatch).toHaveBeenNthCalledWith(2, actions.shippingMethod.accept(response));
        expect(dispatch).toHaveBeenCalledTimes(2);
    });
    ...
    test('submitShippingMethod thunk dispatches actions on failure', async () => {
        ...
        expect(dispatch).toHaveBeenNthCalledWith(1, actions.shippingMethod.submit(payload));
        expect(dispatch).toHaveBeenNthCalledWith(2, actions.shippingMethod.reject(error));
        expect(dispatch).toHaveBeenCalledTimes(2);
    });
    ...
    test('submitShippingMethod thunk throws if there is no guest cart', async () => {
        ...
        await expect(submitShippingMethod(payload)(...thunkArgs)).rejects.toThrow(
            'guestCartId'
        );
    });
});
