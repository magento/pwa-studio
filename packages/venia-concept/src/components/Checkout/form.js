...
class Form extends Component {
    ...
    get addressSummary() {
        ...
        if (!valid) {
            return <span>Add Shipping Information</span>;
        }
    ...
    get editableForm() {
        ...
        switch (editing) {
            ...
            case 'paymentMethod': {
                return <span>Payment Method Form Here</span>;
            }
            case 'shippingMethod': {
                return <span>Shipping Method Form Here</span>;
            }
            default: {
                return null;
            }
