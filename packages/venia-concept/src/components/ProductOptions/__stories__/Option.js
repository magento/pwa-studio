...
stories.add('Option', () => (
    <Option item={swatchItem()} classes={optionClasses} />
));

stories.add('Option disabled', () => (
    <Option item={swatchItemDisabled()} classes={optionClasses} />
));

stories.add('Option selected', () => (
    <Option item={swatchItemSelected()} classes={optionClasses} />
));
