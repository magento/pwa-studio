...
stories.add('Mini Tile', () => (
    <Option item={miniTile} classes={miniTileClasses}>
        Test
    </Option>
));

stories.add('Mini Tile disabled', () => (
    <Option item={miniTileDisabled} classes={miniTileClasses}>
        Test
    </Option>
));

stories.add('Mini Tile selected', () => (
    <Option item={miniTileSelected} classes={miniTileClasses}>
        Test
    </Option>
));

stories.add('Mini Tile disabled and selected', () => (
    <Option item={miniTileDisabledAndSelected} classes={miniTileClasses}>
        Test
    </Option>
));
