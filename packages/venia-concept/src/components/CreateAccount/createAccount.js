...
//TODO: refactor this component in way like SignIn, so that fields in form will consume values from the form's context,
// not from the component's state.
// Also it's better to pass hasEmailError as a field-level validator and split it to isRequired validator and validator
// that checks params from CreateAccount's state.
// hasPasswordConfirmError also should be passed as field-level validator
