...
const getAvailableLocales = requireGraphQL(
    '../queries/getAvailableLocales.graphql'
);
const getAvailableStoreViews = requireGraphQL(
    '../queries/getAvailableStoreViews.graphql'
);
