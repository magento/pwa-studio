...
test('exposes all hooks and targets', async () => {
    ...
    expect(apis.talons).toMatchInlineSnapshot(`
        HookInterceptorSet API (autogenerated from "@magento/peregrine/lib/talons"):
          ...
          talons.CheckoutPage.PaymentInformation.useClearBrainTreeDetails.wrapWith() wraps export "useClearBrainTreeDetails" from "CheckoutPage/PaymentInformation/useClearBrainTreeDetails.js"
