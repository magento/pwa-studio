...
test('exposes all hooks and targets', async () => {
    ...
    expect(apis.talons).toMatchInlineSnapshot(`
        HookInterceptorSet API (autogenerated from "@magento/peregrine/lib/talons"):
          ...
          talons.Wishlist.AddToListButton.useAddToListButton.ac.wrapWith() wraps export "useAddToListButton.ac" from "Wishlist/AddToListButton/useAddToListButton.ac.js"
          talons.Wishlist.AddToListButton.useAddToListButton.mos.wrapWith() wraps export "useAddToListButton.mos" from "Wishlist/AddToListButton/useAddToListButton.mos.js"
