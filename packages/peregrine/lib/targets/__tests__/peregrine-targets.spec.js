...
test('exposes all hooks and targets', async () => {
    ...
    expect(apis.talons).toMatchInlineSnapshot(`
        HookInterceptorSet API (autogenerated from "@magento/peregrine/lib/talons"):
          ...
          talons.Wishlist.GalleryButton.helpers.useSingleWishlist.wrapWith() wraps export "useSingleWishlist" from "Wishlist/GalleryButton/helpers/useSingleWishlist.js"
          talons.Wishlist.GalleryButton.useGalleryButton.ce.wrapWith() wraps export "useGalleryButton.ce" from "Wishlist/GalleryButton/useGalleryButton.ce.js"
          talons.Wishlist.GalleryButton.useGalleryButton.ee.wrapWith() wraps export "useGalleryButton.ee" from "Wishlist/GalleryButton/useGalleryButton.ee.js"
          talons.Wishlist.WishlistButton.useWishlistButton.ce.wrapWith() wraps export "useWishlistButton.ce" from "Wishlist/WishlistButton/useWishlistButton.ce.js"
