...
test('exposes all hooks and targets', async () => {
    ...
    expect(apis.talons).toMatchInlineSnapshot(`
        HookInterceptorSet API (autogenerated from "@magento/peregrine/lib/talons"):
          ...
          talons.MyAccount.useCommunicationsPage.wrapWith() wraps export "useCommunicationsPage" from "MyAccount/useCommunicationsPage.js"
          ...
          talons.OrderHistoryPage.useCollapsedImageGallery.wrapWith() wraps export "useCollapsedImageGallery" from "OrderHistoryPage/useCollapsedImageGallery.js"
