export class TextInput extends React.Component<any, any, any> {
    static propTypes: {
        after: import("prop-types").Requireable<import("prop-types").ReactNodeLike>;
        before: import("prop-types").Requireable<import("prop-types").ReactNodeLike>;
