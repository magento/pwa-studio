...
class CustomContentTypeList {
    ...
    /**
     * Add a rendering strategy to the Pagebuilder component.
     *
     * @param {Object} strategy - Describes the rich content type to include
     * @param {string} strategy.importPath - Import path to the CustomContentTypeRenderer module. Should be package-absolute.
